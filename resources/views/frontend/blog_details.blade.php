                                        ...
                                        <div class="blog__next__prev__post">
                                            <div class="blog__next__prev__thumb">
                                                <a href="blog-details.html"><img
                                                        src="{{ asset('frontend/assets/img/blog/blog_prev.jpg') }}"
                                                        alt=""></a>
                                            </div>
                                ...
                                <div class="col-xl-5 col-md-6">
                                    <div class="blog__next__prev__item next_post text-end">
                                        ...
                                        <div class="blog__next__prev__post">
                                            <div class="blog__next__prev__thumb">
                                                <a href="blog-details.html"><img
                                                        src="{{ asset('frontend/assets/img/blog/blog_next.jpg') }}"
                                                        alt=""></a>
                                            </div>
                                            <div class="blog__next__prev__content">
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__cat">
                                ...
                                <li class="sidebar__cat__item"><a
                                        href="{{ route('category.blog.page', $categori->id) }}">{{ $categori->category
                                        }}</a></li>
                                @endforeach
                            </ul>
                        </div>
