        ...
        <div class="row align-items-center justify-content-center justify-content-lg-between">
            <div class="col-lg-6 order-0 order-lg-2">
                <div class="text-center text-xxl-end">
                    <img src="{{ asset('frontend/assets/img/banner/pt_mattaoi_bumi_sikerei.png') }}" alt="" width="100%">
                </div>
            </div>
            <div class="col-xl-5 col-lg-6">
                <div class="banner__content">
                    <h2 class="title wow fadeInUp" data-wow-delay=".2s"><span>PT. Mattaoi Bumi Sikerei (MBS)</span>
                         {{-- <br> Productin the shortest time. --}}
                        </h2>
                    <p class="wow fadeInUp" data-wow-delay=".4s" style="text-align: justify">Merupakan perusahaan rintisan yang inovatif dari daerah Mentawai yang bergerak di bidang teknologi digital dan pemasaran jasa sebagai virtual asisten yakni mencakup web development, entry data, pembuatan presentasi PowerPoint yang profesional, konversi file, dan penghapusan latar belakang gambar, dsb.</p>
                    ...
                    <div class="col">
                        <div class="portfolio__active">
                            <div class="portfolio__item">
                                ...
                                <div class="portfolio__overlay__content">
                                    <span>UX/UI Design</span>
                                    <h4 class="title"><a href="portfolio-details.html">Animation Management System</a>
                                    </h4>
                                    <a href="portfolio-details.html" class="link">Case Study</a>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section__title">
                        ...
                        <h2 class="title">Yuk konsul gratis tanpa ribet...</h2>
                    </div>
                    <div class="homeContact__content">
                        <p>Silahkan hubungi kami melalui kontak form yang sudah tersedia atau langsung mengklik tombol email di bawah</p>
                        <h2 class="mail"><a href="mailto:libert.jobs@gmail.com">libert.jobs@gmail.com</a></h2>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="homeContact__form">
                        <form action="#">
                            ...
                            <input type="number" placeholder="No. Telp/Wa">
