                ...
                <div class="col-lg-8">
                    ...
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="{{ route('details.blog.page', $item->id) }}"><img src="{{ asset($item->blog_image) }}" width="100%" height="450"></a>
                        ...
                        <div class="standard__blog__content">
                            <div class="blog__post__avatar">
                                ...
                                <span class="post__by"><small>By: Libertus</small></span>
                            </div>
                            <h2 class="title"><a href="{{ route('details.blog.page', $item->id) }}">{{ $item->blog_title }}</a></h2>
                            <p>{!! Str::limit($item->blog_description, 200) !!}</p>
                            <ul class="blog__post__meta">
                                <li><i class="fal fa-calendar-alt"></i> {{ Carbon\Carbon::parse($item->created_at)->diffForHumans() }}
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul class="rc__post">
                                ...
                                <li class="rc__post__item">
                                    ...
                                    <div class="rc__post__content">
                                        <h5 class="title">
                                            <a href="{{ route('details.blog.page', $item->id) }}">{{ $item->blog_title
                                                }}</a>
                                        </h5>
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__cat">
                                ...
                                <li class="sidebar__cat__item"><a
                                        href="{{ route('category.blog.page', $item->id) }}">{{ $item->category
                                        }}</a></li>
                                @endforeach
                            </ul>
                        </div>
