                        ...
                        <nav class="menu__nav">
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li><a href="#servicesTabContent">Services</a></li>
                                    ...
                                    <li class="{{ ($route == 'contact.page') ? 'active' : '' }}"><a href="{{ route('contact.page') }}">contact us</a></li>
                                </ul>
                            </div>
                            <div class="header__btn d-none d-md-block">
                                <a href="{{ route('contact.page') }}" class="btn">Consult here</a>
                            </div>
                        </nav>
                    </div>
                    <!-- Mobile Menu  -->
