            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.portfolio.page') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="portfolio_name" value="{{ $portfolio->portfolio_name }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="portfolio_title" name="portfolio_title" value="{{ $portfolio->portfolio_title }}" placeholder="Portfolio title">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="elm1" name="portfolio_description"
                                       ...
                                       >{{ $portfolio->portfolio_description }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-1">
                                    <img class="card-img-top img-fluid" id="showPortfolioImage"
                                        src="{{ asset($portfolio->portfolio_image) }}" width="100">
                                </div>
                            </div>
